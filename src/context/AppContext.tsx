...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const [lang, setLangState] = useState<LangCode>(() => {
    const saved = localStorage.getItem("rkeeper_lang");
    return (saved === "en" || saved === "ru" || saved === "az") ? saved : "az";
  });
  function setLang(l: LangCode) {
    setLangState(l);
    localStorage.setItem("rkeeper_lang", l);
  }
  function translate(key: string, fallback?: string) { return t(lang, key, fallback); }
